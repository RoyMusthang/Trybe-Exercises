...
Contém todas as atividades desenvolvidas por __[mim](https://www.linkedin.com/in/NoBreakh/)__ durante minha tragetória na [Trybe](https://www.betrybe.com/) :rocket:

## Fundamentos do Desenvolvimento Web :heavy_check_mark:

##### Bloco 1: [Unix, Bash e Shell Script](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_1)
- [x] 1.3 - Fundamentos do Desenvolvimento Web
- [x] 1.3 - Introdução - Unix & Shell
- [x] 1.3 - Unix & Bash - Parte 1
- [x] 1.4 - Unix & Bash - Parte 2

##### Bloco 2: [Git, GitHub e Internet](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_2)
- [x] 2.1 - Git & GitHub  - O que é e para que serve
- [x] 2.2 - Git & GitHub - Entendendo os comandos
- [x] 2.3 - Internet - Entendendo como ela funciona

##### Bloco 3: [Introdução à HTML e CSS](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_3)
...
##### Bloco 4: [Introdução à JavaScript e Lógica de Programação](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_3)
...
##### Bloco 5: [JavaScript: DOM, Eventos e Web Storage](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_5)
...
##### Bloco 6: [HTML e CSS: Forms, Flexbox e Responsivo](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_6)
...
##### Bloco 7: [Introdução à JavaScript ES6 e Testes Unitários](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_7)
- [x] 7.1 - JavaScript ES6 - let, const, arrow functions e template literals
- [x] 7.2 - JavaScript ES6 - Objects
- [x] 7.3 - Testes unitários em JavaScript
- [x] 7.4 - Projeto - JavaScript Testes Unitários

##### Bloco 8: [Higher Order Functions do JavaScript ES6](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_8)
...
##### Bloco 9: [JavaScript Assíncrono e Promises](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_9)
- [x] 9.1 - JavaScript Assíncrono e Callbacks
- [x] 9.2 - JavaScript Promises
- [x] 9.3 - Projeto - Carrinho de Compras

##### Bloco 10: [Testes automatizados com Jest](https://github.com/RoyMusthang/Trybe-Exercises/tree/main/FundamentosDesenvolvimentoWeb/bloco_10)
